...
export const experiences = [
  {
    ...
    description: "Building responsive, user-friendly web applications using React.js, Tailwind CSS, and JavaScript. Focused on clean design, reusable components, and performance best practices.",
    icon: Code,
    achievements: [
  ...
  },
  {
    ...
    company: "GitHub",
    period: "2024 – Present",
    description: "Contributing to open-source JavaScript and React projects by fixing bugs, adding small features, and improving documentation.",
    icon: Rocket,
    achievements: [
  ...
  },
  {
    ...
    company: "Freelance",
    period: "2024 – Present",
    description: "Designed and built modern landing pages and small websites for local clients, ensuring clean, functional, and responsive designs.",
    icon: Star,
    achievements: [
  ...
  },
  {
    ...
    period: "2023 – 2024",
    description: "Completed a structured web development bootcamp and self-learning journey, building projects with React, JavaScript, and modern frontend tools.",
    icon: Heart,
    achievements: [
...
export const personalInfo = {
  ...
  description: "I'm a dedicated frontend developer focused on building clean, responsive, and user-friendly web applications. With solid skills in modern JavaScript frameworks and an eye for detail, I enjoy turning ideas into engaging digital products.",
  additionalInfo: "Currently pursuing my Bachelor's in English while actively developing my skills in web development. I believe in continuous learning and keep up with the latest technologies to deliver quality work.",
  highlights: [
...
export const featuredProjects = [
  {
    title: "Flex Fitness",
    description: "A fitness website for booking gym classes, managing user profiles, and processing secure payments via Stripe.",
    image: image2,
    technologies: ["React", "Firebase", "Tailwind CSS", "Stripe API"],
    liveUrl: "https://fit-gym-7bce5.web.app/",
    githubUrl: "https://github.com/Rakibulislam-emon/Flex-Fitness?tab=readme-ov-file",
  },
  {
    title: "Nest Grocery Shop",
    description: "A full-stack organic grocery e-commerce platform with advanced search, secure payments via Stripe, and user auth with Clerk. Built with React, Express, and MongoDB.",
    image: image3,
...
export const recentProjects = [
  {
    ...
    description: "A smart Chrome extension to save, organize, and manage your important web links with quick add, search, filter, import/export, and clipboard features.",
    image: image5,
  ...
  },
  {
    ...
    description: "A modern full-stack app that lets developers securely manage and delete GitHub repositories with OAuth login, batch operations, and a clean, responsive UI.",
    image: image4,
...
export const projects = [
  {
    ...
    description: "An online grocery shop built with React and Tailwind CSS. Users can browse and buy organic food items easily.",
    image: image1,
    technologies: ["React", "Tailwind CSS"],
    liveUrl: "https://organicgrocerystores.netlify.app/",
    githubUrl: "https://github.com/Rakibulislam-emon/Organic_Grocery_Shop_Client",
  },
  {
    title: "Flex Fitness",
    description: "A fitness website for booking gym classes, managing user profiles, and processing secure payments via Stripe.",
...
export const codeSnippetData = [
  ...
  { text: "  expertise: ['React', 'Next.js', 'Node.js', 'MongoDB'],", color: "#d4d4d4" },
  { text: "  passion: 'Building elegant solutions to complex problems',", color: "#d4d4d4" },
  { text: "", color: "#d4d4d4" },
  ...
  { text: "};", color: "#3B82F6" },
  { text: "", color: "#d4d4d4" },
  { text: "// Let's create something extraordinary together", color: "#10B981" },
];
