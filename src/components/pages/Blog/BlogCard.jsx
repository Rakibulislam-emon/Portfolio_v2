  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div
          className={`flex items-center gap-${featured ? "4" : "3"} ${
            featured ? "mb-4" : "mb-3"
        ...
        <h3
          className={`${featured ? "text-xl" : "text-lg"} font-bold ${
            featured ? "mb-3" : "mb-2"
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {(featured ? post.tags : post.tags.slice(0, 2)).map((tag, index) => (
            <span
              key={index}
              className={`text-xs font-medium px-6 px-${
                featured ? "3" : "2"
              } py-1 rounded-full`}
              style={{
        ...
        {featured ? (
          <div className="flex items-center justify-between">
            ...
            <button
              className="flex items-center gap-2 text-sm font-medium group-hover:scale-110 transition-transform duration-300"
